...
namespace Gleif
{
    ...
    {
        [FunctionName("GleifExtractZip")]
        public static void Run(
            [BlobTrigger("gleif-zip/{name}.zip", Connection = "AzureWebJobsStorage")] CloudBlockBlob inputBlob, 
            string name, 
            string blobTrigger,
            ILogger log,
            ExecutionContext context)
        {
            ...
            {
                // Log Error message and re-throw the Error so the function call gets listed as Failed properly
