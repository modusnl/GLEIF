<#
    source: https://docs.microsoft.com/nl-nl/azure/data-lake-analytics/data-lake-analytics-cicd-overview#deploy-u-sql-database-through-azure-pipelines

    This script is used for getting dependencies and SDKs for U-SQL database deployment.
    PowerShell command line support for deploying U-SQL database package(.usqldbpack file) will come soon.

    Example :
        Get-USQLDBDeploymentSDK.ps1 -AzureSDK "AzureSDKFolderPath" -DBDeploymentTool "DBDeploymentToolFolderPath"
#>

param (
    [string]$AzureSDK = "AzureSDK", # Folder to cache Azure SDK dependencies
    [string]$DBDeploymentTool = "DBDeploymentTool", # Folder to cache U-SQL database deployment tool
    [string]$workingfolder = "USQLDBDeploymentSDK" # Folder to execute these command lines
)
